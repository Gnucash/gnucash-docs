...
<!-- 
      <fo:external-graphic width="auto" height="auto" content-width="36pt" src="url(./stylesheet/note.png)"/>
 -->
<xsl:template match="title" mode="book.titlepage.recto.auto.mode">
    <fo:inline font-weight="bold" font-size="24pt" text-align="center">
    <fo:external-graphic width="auto" height="auto" content-width="24pt" src="url(./images/gnucash-icon.svg)"/>
